...
<html lang="en">
<head>
	<title>Login-Final project cloud</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				...
				<h1 class="cool-title">Final project cloud</h1>
					...
					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Type user name">
						<input id="nomeUtente_log" class="input100" type="text" name="nomeUtente_log" placeholder="User name">
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 rs2-wrap-input100 validate-input m-b-20" data-validate="Type password">
						<input class="input100" type="password" name="pass_log" placeholder="Password">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="w-full text-center p-t-27 p-b-239">
						...
						<a href="/webPage/registrati.php" class="txt2">
						REGISTRATI
						</a>
					</div>
					<!--<div class="w-full text-center p-t-27 p-b-239">
